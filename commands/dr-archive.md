...
The CTA block MUST follow the canonical format. If multiple tasks remain active after this archive, render the variant-B menu of other active tasks per `cta-format.md`.
