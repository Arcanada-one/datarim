...
# 2. Save the JSON to ${ARCANADA_CREDS_DIR:-$HOME/.config/datarim}/client_secret_<id>.json (mode 0600).
...
/tmp/ga4-tools/bin/python3 - <<'PY'
import os, glob
from google_auth_oauthlib.flow import InstalledAppFlow

creds_dir = os.environ.get('ARCANADA_CREDS_DIR', os.path.expanduser('~/.config/datarim'))
