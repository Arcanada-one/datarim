...
Source: prior incident reflection — heredoc approach broke on restic+B2 deploy scripts across the web, prod and db servers. Base64 pattern resolved it universally.
