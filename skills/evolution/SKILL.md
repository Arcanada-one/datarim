...
|------|---------|----------|--------|--------|-----------|
| 2026-04-11 | OPT-001 | prune-skill | skills/<retired-skill>/SKILL.md | Removed unused skill | No agent references it |
```
