...
**Source:** the Datarim v2.0.0 absorption of 14 external skills, its follow-on dead-cross-reference
cleanup, and the regression gate added after that cleanup (see `documentation/how-to/evolution-log.md`
for provenance). This pattern is the sibling of `## Pattern: Split-Architecture Metrics for Absorption
