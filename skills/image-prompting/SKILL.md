...
description: Author prompts for image-generation tools — covers, thumbnails, post visuals, illustrations, infographics, logos. Covers intake, composition, camera/light/palette, text-in-image, negative constraints, native aspect/size, iterative refinement.
