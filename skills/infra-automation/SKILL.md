...
|------|-----------|-------------|-----|
| Arcana WWW | 49.13.52.208 | 100.64.0.11 | `ssh root@49.13.52.208` |
| Arcana PROD | 65.108.236.39 | 100.64.0.12 | `ssh root@65.108.236.39` |
| Arcana DB | 135.181.222.38 | 100.64.0.13 | `ssh root@135.181.222.38` |
| Arcana Trading | 37.27.107.227 | 100.64.0.14 | `ssh root@37.27.107.227` |
...
```bash
declare -A TSIP=([www]=100.64.0.11 [prod]=100.64.0.12 [db]=100.64.0.13 [trading]=100.64.0.14)
