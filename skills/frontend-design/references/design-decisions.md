<!-- fd-rule: FD-DESIGN-TITLE; polarity: inform; semantics: design.title -->
# Frontend design decisions

<!-- fd-rule: FD-DESIGN-SCOPE; polarity: inform; semantics: design.scope -->
...
<!-- fd-rule: FD-DESIGN-VISITOR; polarity: require; semantics: design.visitor_decision -->
...
<!-- fd-rule: FD-DESIGN-REUSE; polarity: require; semantics: design.reuse_first -->
...
<!-- fd-rule: FD-DESIGN-DIRECTION; polarity: require; semantics: design.selected_direction -->
...
<!-- fd-rule: FD-DESIGN-TOKENS; polarity: require; semantics: design.semantic_visual_rules -->
...
<!-- fd-rule: FD-DESIGN-RESPONSIVE; polarity: require; semantics: design.responsive_i18n -->
...
<!-- fd-rule: FD-DESIGN-A11Y; polarity: require; semantics: design.accessibility_performance -->
