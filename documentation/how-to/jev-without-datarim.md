...
|---|---|---|---|
| Framework + routing | yes | yes | `./install.sh --project P`; answer its Jev question with "project" or "host" |
| Framework only | yes | no | `./install.sh --project P`; answer its Jev question with "none" |
