...
- For DBs managed outside the code repo (e.g. `analytics_db` — no `migrations/` folder; manual ALTER on local + prod), note this inline so reviewers (human or AI) do not flag a missing migration file as a blocker.
